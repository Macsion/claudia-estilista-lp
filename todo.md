# Project TODO - Claudia Estilista Landing Page

## Estructura y Setup
- [x] Crear estructura HTML base con semántica correcta
- [x] Configurar tipografías (Cormorant Garamond, Raleway)
- [x] Crear variables CSS para colores y espaciados
- [x] Configurar reset CSS y estilos base

## Secciones Principales
- [x] Hero Section con imagen de fondo y overlay
- [x] Logo circular en hero
- [x] Sección de Servicios con grid 6 items
- [x] Galería de Trabajos (Masonry/Pinterest style)
- [x] Sección Sobre Claudia con foto y badges
- [x] Testimonios (3 cards)
- [x] Ubicación y Contacto con Google Maps
- [x] CTA Final (Transformación)
